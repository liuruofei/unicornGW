#pragma checksum "D:\younengkao\manage\WebManager\Areas\Admin\Views\Manage\Banner\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7da703a9511c8ed79b16c2156703093c52ab6da5"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7da703a9511c8ed79b16c2156703093c52ab6da5", @"/Areas/Admin/Views/Manage/Banner/Index.cshtml")]
...
#line 60 "D:\younengkao\manage\WebManager\Areas\Admin\Views\Manage\Banner\Index.cshtml"
         Write(Url.Action("GetDataSource"));

#line default
#line hidden
                EndContext();
                BeginContext(2174, 1741, true);
                WriteLiteral(@"',
        page: true,
        cellMinWidth: 100,
        cols: [[
            { type: 'numbers' },
            {
                field: 'BannerImage', title: '图片', sort: true, width: 224,
                templet: function (d) {
                    if (d.BannerImage != null && d.BannerImage != '') {
                        return ""<a href='"" + + d.BannerImage + ""' target='_blank'><img src='"" + d.BannerImage + ""' style='width:180px;height:130px'/></a>"";
                    }
                    else {
                        return """";
                    }
...
#line 116 "D:\younengkao\manage\WebManager\Areas\Admin\Views\Manage\Banner\Index.cshtml"
                          Write(Url.Action("Edit"));

#line default
#line hidden
                EndContext();
                BeginContext(3934, 21, true);
...
#line hidden
                EndContext();
                BeginContext(3973, 171, true);
                WriteLiteral("?ID=0\',\r\n            end: function () {\r\n                insTb.reload();\r\n            }\r\n        });\r\n    }\r\n    //删除\r\n    function doDel(Id) {\r\n        adminList.delete(\'");
                EndContext();
                BeginContext(4145, 20, false);
#line 124 "D:\younengkao\manage\WebManager\Areas\Admin\Views\Manage\Banner\Index.cshtml"
