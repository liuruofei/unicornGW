#pragma checksum "D:\younengkao\manage\WebManager\Areas\Admin\Views\Manage\Course\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4811898943391f34e1fe680aa261b47299a3e4d9"
// <auto-generated/>
...
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Areas/Admin/Views/Manage/Course/Index.cshtml", typeof(AspNetCore.Areas_Admin_Views_Manage_Course_Index))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4811898943391f34e1fe680aa261b47299a3e4d9", @"/Areas/Admin/Views/Manage/Course/Index.cshtml")]
...
#line 60 "D:\younengkao\manage\WebManager\Areas\Admin\Views\Manage\Course\Index.cshtml"
         Write(Url.Action("GetDataSource"));

#line default
#line hidden
                EndContext();
                BeginContext(2176, 1786, true);
                WriteLiteral(@"',
        page: true,
        cellMinWidth: 100,
        cols: [[
            { type: 'numbers' },
            {
                field: 'ImgUrl', title: '课程图片', sort: true, width: 224,
                templet: function (d) {
            ...
            { field: 'CourseTitle', title: '课程标题', sort: true },
...
");
                WriteLiteral(@"        var title = $('#txtTitle').val();
        insTb.reload({
            where: { title: title }
            , page: {
                curr: 1 //重新从第 1 页开始
    ...
    function showEditModel(vmodel) {
        adminList.form({
            ...
            content: vmodel ? '");
                EndContext();
                BeginContext(3963, 18, false);
#line 117 "D:\younengkao\manage\WebManager\Areas\Admin\Views\Manage\Course\Index.cshtml"
...
#line hidden
                EndContext();
                BeginContext(4020, 171, true);
                WriteLiteral("?ID=0\',\r\n            end: function () {\r\n                insTb.reload();\r\n            }\r\n        });\r\n    }\r\n    //删除\r\n    function doDel(Id) {\r\n        adminList.delete(\'");
                EndContext();
                BeginContext(4192, 20, false);
#line 125 "D:\younengkao\manage\WebManager\Areas\Admin\Views\Manage\Course\Index.cshtml"
                     Write(Url.Action("Delete"));

#line default
#line hidden
                EndContext();
                BeginContext(4212, 100, true);
